...
class Settings(BaseModel):
    ...
    web_user_agent: str = os.getenv("AGENT_WEB_USER_AGENT", "SuperAgent/0.2")
...
settings = Settings()
for p in [settings.workspace, settings.memory_db.parent, settings.approval_db.parent, settings.audit_log.parent, settings.artifacts_dir]:
